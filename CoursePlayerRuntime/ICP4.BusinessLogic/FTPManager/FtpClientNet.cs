...
namespace LCMS.Common
{
    ...
    public class FTPclientNet
    {
        ...
        /// <FTPclientNet></remarks>
        public FTPclientNet(string Hostname)
        {
            _hostname = Hostname;
        }
        ...
        /// <remarks></remarks>
        public FTPclientNet(string Hostname, string Username, string Password)
        {
            _hostname = Hostname;
            _username = Username;
            _password = Password;
        ...
        {
            bool isDownloadSucessful = false;
            //1. check target
