...
namespace _360Training.TrackingService.VUConnectorService {
    ...
    public partial class LCMS_VUConnectorServiceService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public LCMS_VUConnectorServiceService() {
            this.Url = global::_360Training.TrackingService.Properties.Settings.Default._360Training_TrackingService_VUConnectorService_LCMS_VUConnectorServiceService;
        ...
        public bool UpdateCourseStatus(string CourseGUID, double EnrollmentID, double CourseStatus, double LCMSTimeSpent) {
        ...
        /// <remarks/>
        public void UpdateCourseStatusAsync(string CourseGUID, double EnrollmentID, double CourseStatus, double LCMSTimeSpent) {
            this.UpdateCourseStatusAsync(CourseGUID, EnrollmentID, CourseStatus, LCMSTimeSpent, null);
        }
        
        /// <remarks/>
        public void UpdateCourseStatusAsync(string CourseGUID, double EnrollmentID, double CourseStatus, double LCMSTimeSpent, object userState) {
            ...
            this.InvokeAsync("UpdateCourseStatus", new object[] {
                        ...
                        EnrollmentID,
                        CourseStatus,
                        LCMSTimeSpent}, this.UpdateCourseStatusOperationCompleted, userState);
        }
        ...
        public void PublishCourseWithPackageAsync(
                    ...
                    double Delivery, 
                    double MSRP) {
            this.PublishCourseWithPackageAsync(Name, Description, hour, LCMSCourseGUID, Cost, TimeOutDays, Type, Tier, Available, VerticalID, ClientID, StateID, AsvID, CommType, Commission, Delivery, MSRP, null);
        }
        ...
        public void PublishCourseWithPackageAsync(
            ...
            this.InvokeAsync("PublishCourseWithPackage", new object[] {
                        ...
                        Commission,
                        Delivery,
                        MSRP}, this.PublishCourseWithPackageOperationCompleted, userState);
        }
